...
/**
 * Clase para el filtro de la lista de proyectos
 */
public class filtroProyectoListener implements ActionListener {
    // Variables
     ...
     */
    public filtroProyectoListener(ListaProyectos ventana) {
